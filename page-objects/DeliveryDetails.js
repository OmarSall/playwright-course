...
export class DeliveryDetails {
    constructor(page) {
        ...
        this.cityInput = page.locator('[data-qa="delivery-city"]') //CSS selector
    ...
    saveDetails = async () => {
        ...
        expect(await this.saveAddressFirstName.first().innerText()).toBe(await this.lastNameInput.inputValue())
